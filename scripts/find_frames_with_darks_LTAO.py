...
night = tu.good_kapa_night_list[0]
print(night)
...
# And which don't have the AO hatch open
ao_hatch_open_mask = np.array(hdr_tbl['ao_hatch_open'].value.tolist())
not_ao_hatch_open_mask = ~ao_hatch_open_mask
print(f"Found {sum(not_ao_hatch_open_mask)} images with the AO hatch closed.")
...
good_mask = four_lgs_image_mask & not_aborted_mask & not_pinhole_mask & (wfsblank1_mask | setup_mask | darks_mask) & not_ao_hatch_open_mask
